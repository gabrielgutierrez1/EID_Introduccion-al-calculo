...
from src.funciones_por_tramos import analizar_funcion_por_tramos
...
from .formatters import formatear_resultado_rut, formatear_resultado_conica, formatear_resultado_tramos
