...
def analizar_conica(digitos, dv):
    from .canonica_a_general import transformar_canonica_a_general
    ...
    transformacion = transformar_a_canonica(coeficientes, tipo, ecuacion_general, formatear_numero)
